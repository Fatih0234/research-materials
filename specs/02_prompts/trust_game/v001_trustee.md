# Trust Game Prompt Template: Trustee Role (v001)
...
5. **Repeated Rounds:** For repeated games, the prompt would include history of previous rounds. See separate prompt template (not in v001).
...
```
The other player showed significant trust by giving me $7, which means they trusted me with a substantial portion of their endowment. I received $21 as a result. Given my compassionate nature and belief in fairness, I want to reward that trust.

I recognize that they took a risk, and reciprocating appropriately is the right thing to do. They started with $10 and gave me $7, keeping only $3 for themselves. I should return enough to make their trust worthwhile.
