# Trust Game Prompt Template: Trustor Role (v001)
...
4. **Repeated Rounds:** For repeated games, see separate prompt template (not in v001).
...
```
I'm being asked to decide how much money to give to another player in this experiment. Given my analytical nature, I would approach this with a balance of trust and caution. The multiplier effect means my contribution gets tripled, so if I send $5, they receive $15. If they're reciprocally minded, they might return more than I sent. However, there's risk involved.

I believe a moderate amount shows trust without being overly naive. Based on my tendency to excel through careful analysis, I would send an amount that demonstrates good faith while protecting against complete loss.
