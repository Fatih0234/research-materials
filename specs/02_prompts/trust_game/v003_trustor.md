# Trust Game Prompt Template: Trustor Role (v003)
...
4. **Repeated Rounds:** For repeated games, see separate prompt template (not in v003).
...
```
I want to show trust while staying cautious.
